...
// is not in the package's known-messages map. Callers that want to silently
// skip unknown messages (the common case for game-server extensions we
// don't model) can detect it with errors.Is.
